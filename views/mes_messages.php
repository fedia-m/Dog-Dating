...
<div class="container-fluid">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <h2>Destinataire: </h2> <h3><?php echo $infoProprioD[$i]->getPrenom().' '.$infoProprioD[$i]->getNom(); ?></h3>
                                            <p>
                        ...
                        <div class="card card-body bg-light">
                            <div class="banner-area">
                                ...
                                <a href="<?php echo BASE_URL ?>controllers/supprimer_message.php?idMessage=<?php echo $messageRecus[$i]->getId() ?>"><i class="fa fa-times" aria-hidden="true"></i></a>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <h2>Expéditaire: </h2> <h3><?php echo $infoProprioE[$i]->getPrenom().' '.$infoProprioE[$i]->getNom(); ?></h3>
                                            <p>
                                                <?php echo $messageRecus[$i]->getContenuMessage(); ?>
                                            </p>
                                        </div>
                                    </div>
                                    <div id="reponse" hidden>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <textarea rows="4" id="reponseMail" name="reponseMail"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <a href="#" onclick="reponseMessage();return false;">
    ...
    <div class="row">
        <?php if (count($messageEnvoyes)<>0) {
            ?>
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mx-auto">
            <div class="card-title text-center"><h2><i class="fa fa-chevron-circle-up" aria-hidden="true"></i> Envoyés
                </h2></div>
            <?php
            for ($i = 0; $i < count($messageEnvoyes); $i++) {
                                ...
                                <div class="row">
                                    ...
                                    if ($messageEnvoyes[$i]->getMessageArchiveD() == $messageEnvoyes[$i]->getMessageArchiveE()) {
                                        ...
                                        <div class="col-lg-2 col-md-1 col-sm-1">
                                            <a href="<?php echo BASE_URL ?>views/edit_profil.php?idMessage=<?php echo $messageEnvoyes[$i]->getId() ?>"><i
